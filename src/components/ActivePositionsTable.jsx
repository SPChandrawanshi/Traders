...
const ActivePositionsTable = () => {
    ...
    return (
        <div className="mb-6">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse whitespace-nowrap">
                        ...
                        <tbody className="text-[13px] text-slate-300">
                            {positions.map((pos) => (
                                <tr key={pos.scrip} className="border-b border-[#2d3748] bg-[#1a2333]/50">
            ...
            <div className="p-4 bg-[#151c2c] rounded-b-lg md:rounded-t-none border-x border-b border-[#2d3748] md:border-none">
